...
* **Responsabilité :** L'éditeur ne peut être tenu responsable des pertes financières ou des erreurs de transaction. Vérifiez toujours les prix sur les plateformes officielles avant toute transaction.

### 3. Propriété Intellectuelle
* **Non-Affiliation :** Cette application est un projet de fan **non-officiel**. Elle n'est pas affiliée à, approuvée par, ou soutenue par Nintendo, Creatures, GAME FREAK ou The Pokémon Company.
* **Marques :** Pokémon et les noms de personnages sont des marques déposées de leurs propriétaires respectifs.
...
* **Liability:** The developer shall not be held liable for any financial losses or transaction errors. Always verify prices on official platforms before any transaction.

### 3. Intellectual Property
* **Non-Affiliation:** This app is an **unofficial** fan project. It is not affiliated with, endorsed by, or supported by Nintendo, Creatures, GAME FREAK, or The Pokémon Company.
* **Trademarks:** Pokémon and character names are registered trademarks of their respective owners.
